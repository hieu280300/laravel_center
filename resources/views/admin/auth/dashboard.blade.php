...
<div class="container">
    @auth('admin')
        ...
        <a href="/admin/pages/auth/index.html">Go to Demo</a>
    @endauth
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li> <form action="{{ route('admin.logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="fa fa-sign-out fa-fw"">Logout</button>
                            </form>
                            </li>
                        </ul>
                    </li>
